...
class WhoWeAreMissionVissionController extends Controller
{
    protected $cmsService;

    public $name = "whoweare";
    public $section = "mission_vission";
    public $page = PageEnum::WHOWEARE;
    public $item = SectionEnum::WHOWEARE_MISSION_VISSION;
    public $items = SectionEnum::WHOWEARE_MISSION_VISSIONS;
    public $count = 2;
