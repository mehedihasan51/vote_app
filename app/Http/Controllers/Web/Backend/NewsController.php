...
class NewsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('thumbnail')) {
                $data['thumbnail'] = Helper::fileUpload($request->file('thumbnail'), 'news', time() . '_' . getFileName($request->file('thumbnail')));
            }
        ...
        return redirect()->route('admin.news.index')->with('t-success', 'news created successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->hasFile('thumbnail')) {
                $validate['thumbnail'] = Helper::fileUpload($request->file('thumbnail'), 'news', time() . '_' . getFileName($request->file('thumbnail')));
            }
        ...
        return redirect()->route('admin.news.edit', $news->id)->with('t-success', 'news updated successfully');
    }
