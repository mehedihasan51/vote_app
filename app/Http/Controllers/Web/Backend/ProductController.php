...
class ProductController extends Controller
{
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    return '<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                ...
                                <a href="#" type="button" onclick="goToEdit(' . $data->id . ')" class="btn btn-primary fs-14 text-white delete-icn" name="Delete">
                                    <i class="fe fe-edit"></i>
                                </a>

                                <a href="#" type="button" onclick="goToOpen(' . $data->id . ')" class="btn btn-success fs-14 text-white delete-icn" name="Delete">
                                    <i class="fe fe-eye"></i>
                                </a>
                ...
                ->rawColumns(['category', 'name', 'thumbnail', 'status', 'action'])
                ->make();
        }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('thumbnail')) {
                $data['thumbnail'] = Helper::fileUpload($request->file('thumbnail'), 'products', time() . '_' . getFileName($request->file('thumbnail')));
            }
        ...
        return redirect()->route('admin.product.index')->with('t-success', 'post created successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.product.index')->with('t-success', 'post updated successfully');
    }
