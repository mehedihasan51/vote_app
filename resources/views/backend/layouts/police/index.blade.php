@extends('backend.app', ['title' => 'police'])
                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('admin.police.create') }}" class="btn btn-primary btn-sm">Add</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
...
<script>
    ...
    function statusChange(id) {
        NProgress.start();
        let url = "{{ route('admin.police.status', ':id') }}";
        $.ajax({
            type: "GET",
    ...
    function goToOpen(id) {
        let url = "{{ route('admin.police.show', ':id') }}";
        window.location.href = url.replace(':id', id);
    }
</script>
@endpush