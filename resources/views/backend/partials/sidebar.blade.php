    ...
    <div class="app-sidebar" style="overflow: scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('admin.news.*') ? 'has-link' : '' }}" href="{{ route('admin.news.index') }}">
                        <i class="fa-solid fa-newspaper side-menu__icon"></i>
                        <span class="side-menu__label">News</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('leader') ? 'has-link' : '' }}" href="{{ route('admin.leader.index') }}">
                        <i class="fa-solid fa-chess-king side-menu__icon"></i>
                        <span class="side-menu__label">Leader</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('event') ? 'has-link' : '' }}" href="{{ route('admin.event.index') }}">
                        <i class="fa-solid fa-calendar-days side-menu__icon"></i>
                        <span class="side-menu__label">Events</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('survey') ? 'has-link' : '' }}" href="{{ route('admin.survey.index') }}">
                ...
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('product') ? 'has-link' : '' }}" href="{{ route('admin.product.index') }}">
                ...
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('donation') ? 'has-link' : '' }}" href="{{ route('admin.donation.index') }}">
                        <i class="fa-solid fa-hand-holding-dollar side-menu__icon"></i>
                        <span class="side-menu__label">Donations</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('area') ? 'has-link' : '' }}" href="{{ route('admin.area.index') }}">
                        <i class="fa-solid fa-map side-menu__icon"></i>
                        <span class="side-menu__label">Area</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('branch') ? 'has-link' : '' }}" href="{{ route('admin.branch.index') }}">
                        <i class="fa-solid fa-map-location-dot side-menu__icon"></i>
                        <span class="side-menu__label">Branch</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item {{  request()->routeIs('police') ? 'has-link' : '' }}" href="{{ route('admin.police.index') }}">
                        <i class="fa-solid fa-building-shield side-menu__icon"></i>
                        <span class="side-menu__label">police</span>
                    </a>
                </li>
                <li>
                    <h3>Components</h3>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.cms.home.about_cmc.index') }}" class="slide-item">About CMC Section</a></li>
                        <li><a href="{{ route('admin.cms.home.donate.index') }}" class="slide-item">Donate Section</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.whoweare.banner.index') }}" class="slide-item">Banner Section</a></li>
                        <li><a href="{{ route('admin.cms.whoweare.committed.index') }}" class="slide-item">Committed Section</a></li>
                        <li><a href="{{ route('admin.cms.whoweare.difference.index') }}" class="slide-item">Difference Section</a></li>
                        <li><a href="{{ route('admin.cms.whoweare.mission_vission.index') }}" class="slide-item">Mission & Vission Section</a></li>
                        <li><a href="{{ route('admin.cms.whoweare.discover_values.index') }}" class="slide-item">Discover Values Section</a></li>
                    </ul>
                </li>
            </ul>
